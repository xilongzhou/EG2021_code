...
class AlignedDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.mode=opt.mode
        self.augment_color= True if opt.augment_color else False
...
class AlignedDataset_Real(BaseDataset):
    ...
    def __getitem__(self, index): 
        ...
        # image_index = np.random.randint(image_number, size=2)
        ...
        # we load linear [0,1] real images for training, since we need to compute invariance scaling factor
