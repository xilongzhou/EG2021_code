...
def SingleRender_NumberPointLight_FixedCamera(diff_image, spec_image, normal_image, roughness_image, LightPosition, Position_map, mydevice, Near_Number, low_cam):
