...
class BaseOptions():
    ...
    def initialize(self):  
        ...
        self.parser.add_argument('--logs', action='store_true', help='use dropout for the generator')
        ...
        self.parser.add_argument('--mode', type=str, default='Syn',help='Syn or Real')
        ...
        self.parser.add_argument('--use_dropout_G', action='store_true', help='use dropout for the generator')
        ...
        # for setting inputs
        self.parser.add_argument('--loginput', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')                
        self.parser.add_argument('--rand_light', type=float, default=0.5, help='random light for augment input')                
        self.parser.add_argument('--augment_input', action='store_true', help='only do one epoch and displays at each iteration')
        self.parser.add_argument('--augment_color', action='store_true', help='only do one epoch and displays at each iteration')        
        self.parser.add_argument('--dataroot', type=str, default='F:/LoganZhou/Research/dataset/DeepMaterialsData/ImageData/SynTrainData') 
        ...
        self.parser.add_argument('--LowCam', action='store_true', help='Camera: [0,0,2.14]; Camera: [0,0,1y]')        
        ...
        self.parser.add_argument('--no_real_vgg_loss', action='store_true', help='real for vgg or not') 
        self.parser.add_argument('--real_dataroot', type=str, default='F:/LoganZhou/Research/dataset/DeepMaterialsData/ImageData/RealTrainData2_Linear') 
        ...
        self.parser.add_argument('--n_blocks_branch', type=int, default=4, help='number of residual blocks in the global generator network (branch)')
